...
namespace OrderSystem {
    ...
    public partial class StoreDataSet : global::System.Data.DataSet {
        ...
        public partial class MenuDataTable : global::System.Data.TypedTableBase<MenuRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public MenuRow AddMenuRow(int ProductID, string ProductName, string ProductType, int Price) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public MenuRow FindByProductID(int ProductID) {
        ...
        public partial class MenuRow : global::System.Data.DataRow {
            ...
            public int ProductID {
                get {
                    return ((int)(this[this.tableMenu.ProductIDColumn]));
                }
                set {
                    this[this.tableMenu.ProductIDColumn] = value;
                }
            }
            ...
            public string ProductName {
                get {
                    return ((string)(this[this.tableMenu.ProductNameColumn]));
                }
                set {
                    this[this.tableMenu.ProductNameColumn] = value;
                }
            }
            ...
            public string ProductType {
                get {
                    return ((string)(this[this.tableMenu.ProductTypeColumn]));
                }
                set {
                    this[this.tableMenu.ProductTypeColumn] = value;
                }
            }
...
namespace OrderSystem.StoreDataSetTableAdapters {
    ...
    public partial class MenuTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Menu] WHERE (([ProductID] = @Original_ProductID) AND ([Product" +
                "Name] = @Original_ProductName) AND ([ProductType] = @Original_ProductType) AND (" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Menu] ([ProductID], [ProductName], [ProductType], [Price]) VAL" +
                "UES (@ProductID, @ProductName, @ProductType, @Price);\r\nSELECT ProductID, Product" +
                "Name, ProductType, Price FROM Menu WHERE (ProductID = @ProductID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Menu] SET [ProductID] = @ProductID, [ProductName] = @ProductName, [ProductType] = @ProductType, [Price] = @Price WHERE (([ProductID] = @Original_ProductID) AND ([ProductName] = @Original_ProductName) AND ([ProductType] = @Original_ProductType) AND ([Price] = @Original_Price));
SELECT ProductID, ProductName, ProductType, Price FROM Menu WHERE (ProductID = @ProductID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ProductID, ProductName, ProductType, Price FROM dbo.Menu";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT ProductID, ProductName, ProductType, Price FROM dbo.Menu";
        ...
        public virtual int Fill(StoreDataSet.MenuDataTable dataTable) {
        ...
        public virtual StoreDataSet.MenuDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            StoreDataSet.MenuDataTable dataTable = new StoreDataSet.MenuDataTable();
        ...
        public virtual int FillBy(StoreDataSet.MenuDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(StoreDataSet.MenuDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ProductID, string Original_ProductName, string Original_ProductType, int Original_Price) {
        ...
        public virtual int Insert(int ProductID, string ProductName, string ProductType, int Price) {
        ...
        public virtual int Update(int ProductID, string ProductName, string ProductType, int Price, int Original_ProductID, string Original_ProductName, string Original_ProductType, int Original_Price) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string ProductName, string ProductType, int Price, int Original_ProductID, string Original_ProductName, string Original_ProductType, int Original_Price) {
            return this.Update(Original_ProductID, ProductName, ProductType, Price, Original_ProductID, Original_ProductName, Original_ProductType, Original_Price);
        }
    }
